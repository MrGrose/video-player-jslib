...
## Использование `livereload cli`
  ...
  Создайте папку и положите index.html и прочие файлы в папку dist/ и запустить одну команду в терминале.
  Перейдите в каталог с вашими файлами через командную строку.

  Запустите сервер live-reload с помощью команды:
  ...
  Liverreload автоматически перезагружает страницу в браузере при обнаружении изменений в файлах внутри текущего каталога.

  С подробной документацией можно ознакомится [тут](https://pypi.org/project/livereload/)
